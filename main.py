...
def start_training(character):
    ...
    commands = {
        'attack': character.attack(character.char_name, character.char_class),
        'defence': character.defence(character.char_name, character.char_class),
        'special': character.special(character.char_name, character.char_class)}
